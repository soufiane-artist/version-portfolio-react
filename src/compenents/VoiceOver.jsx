    ...
    const projectsData = [
        {
            ...
            title:'Project 1',
            description:'a specialist in marketing voice-over for showcasing and selling physical products in an engaging and persuasive style. I highlight your product’s strengths and turn interest into action — with a voice that speaks to needs and drives decisions'
        },
        {
